 ...
 */
package com.pragmatickm.contact.style.book;
...
@WebServlet("/contact/style/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		HttpServletUtil.sendRedirect(
			...
			"/contact/style/apidocs/com.pragmatickm.contact.style/com" + Objects.toString(req.getPathInfo(), ""),
